    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('createStory') }}"  enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input name="fileup"  type="file" class="form-control-file" id="exampleFormControlFile1" required>
                          </div>
